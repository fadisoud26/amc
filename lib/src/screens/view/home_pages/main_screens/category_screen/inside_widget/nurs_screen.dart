...
class NursScreen extends StatelessWidget {
  static const String id = '/nurs_screen';
  NursScreen({super.key});
  final NursScreenController controller = Get.find();
      ...
      body: Column(
        children: [
          DoctorDeviceNurseAppBar(
            ...
            deviceNameIfForNurse: controller.arguments[PageArgName.deviceName],
            onTap: () => Get.back(),
            onTapSeeMore: () => Get.toNamed(
              ...
              arguments: {
                ...
                PageArgName.nursName: controller.arguments[PageArgName.name],
              },
            ),
          ),
          sizedBoxH20,
